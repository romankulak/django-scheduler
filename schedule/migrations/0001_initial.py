    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calendar', models.ForeignKey(blank=True, null=True, to='schedule.Calendar', verbose_name='calendar', on_delete=models.SET_NULL)),
                ('creator', models.ForeignKey(blank=True, null=True, related_name='creator', verbose_name='creator', to=settings.AUTH_USER_MODEL, on_delete=models.SET_NULL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='event',
            name='rule',
            field=models.ForeignKey(blank=True, null=True, to='schedule.Rule', verbose_name='rule', help_text="Select '----' for a one time only event.", on_delete=models.SET_NULL),
